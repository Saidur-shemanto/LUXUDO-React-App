...
const BulletInfoImage = (props) => {
    ...
    return (
        <div className='w-full relative flex justify-center items-center '>
            ...
            <img id='parent2' src={image2} className='absolute z-10 w-64 h-72 right-[220px] top-[270px] border-white border-8 rounded-lg' alt="" data-aos="fade-left" />
            <img src={image3} className='absolute z-20 w-44 h-52 left-[220px] top-[380px] border-8 rounded-lg border-white' alt="" data-aos="fade-right" />
