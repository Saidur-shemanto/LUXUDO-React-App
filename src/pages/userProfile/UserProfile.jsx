...
const UserProfile = (props) => {
    ...
    return (
        <div className="grid grid-cols-5 h-[70vh]">
            <div className="flex flex-col justify-center items-center col-span-5 lg:col-span-1 gap-20 bg-slate-700 text-white">
                <div className="relative flex justify-center">
                    ...
                    <dialog id="my_modal_1" className="modal ">
                        <div className="modal-box bg-black">
                            <form onSubmit={handleSubmit(onPhotoSubmit)}>
                ...
                <div className="space-y-4">
                    <div className="flex gap-2">
                        ...
                        <HiOutlinePencilAlt className="text-3xl " onClick={() => document.getElementById('my_modal_2').showModal()}></HiOutlinePencilAlt>
                        ...
                        <div className="modal-box bg-black">
                            <form onSubmit={handleSubmit(onNameSubmit)}>
                                <div className="form-control">
                                    ...
                                    <input type="text" name="image" placeholder="Image URL" className="input text-black input-bordered" {...register("name")} required />
                                    <button className="mt-2 mx-auto btn w-1/5">Submit</button>
                                </div>
                            </form>
